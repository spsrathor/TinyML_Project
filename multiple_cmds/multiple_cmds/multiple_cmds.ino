...
#include <PDM.h>
#include <multiple_voice_inferencing.h>
...
void loop()
{
    ...
    if (++print_results >= (EI_CLASSIFIER_SLICES_PER_MODEL_WINDOW)) {
        ...
        if (top_label != nullptr) {
            ...
            if (strcmp(top_label, "ON") == 0 || strcmp(top_label, "UP") == 0) {
                digitalWrite(LEDR, LOW);
                strcpy(led_status, "ON");
                // ei_printf("LED ON\n");
            }
            else if (strcmp(top_label, "OFF") == 0 || strcmp(top_label, "DOWN") == 0) {
